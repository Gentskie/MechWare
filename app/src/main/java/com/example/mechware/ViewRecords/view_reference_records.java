...
public class view_reference_records extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    EditText  date_editText, total_time_in_service_editText, reference_editText;
    Button restore_btn, submit_btn;

    FirebaseDatabase rootNode;
    DatabaseReference userRef, user_type_ref, uidRef, aircraftRecordRef, aircraftIDRef, referenceRef;
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_reference_records_layout);
...
//        user_type_ref = userRef.child(user_type);
        ...
        referenceRef = aircraftIDRef.child("Reference_of_Major_Repairs");
        ...
        navigationView.getMenu().findItem(R.id.nav_reference).setVisible(false);
        ...
        if(action_type.equalsIgnoreCase("view")){
            ...
            reference_editText.setFocusable(false);
        ...
        submit_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                referenceRef.setValue(referenceHelper);
                Toast.makeText(view_reference_records.this, "Reference of Major Repairs Record has been updated", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void setRecord(){
        referenceRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                ReferenceHelper helper = snapshot.getValue(ReferenceHelper.class);

                date_editText.setText(helper.date);
                total_time_in_service_editText.setText(helper.total_time);
                reference_editText.setText(helper.reference);
            }
                ...
                aircraftIDRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("Form_1")){
                            ...
                            Toast.makeText(view_reference_records.this, "This Aircraft Record doesn't have Form 1 Record~", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                ...
                aircraftIDRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("Description_of_Inspection")){
                            ...
                            Toast.makeText(view_reference_records.this, "This Aircraft Record doesn't have Reference of Major Repairs Record~", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                ...
                aircraftIDRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("Airworthiness_Directive")){
                            ...
                            Toast.makeText(view_reference_records.this, "This Aircraft Record doesn't have Airworthiness Directive Record~", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                ...
                aircraftIDRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("Mandatory_Services")){
                            ...
                            Toast.makeText(view_reference_records.this, "This Aircraft Record doesn't have Mandatory Services Record~", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
                ...
                aircraftIDRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        if(snapshot.hasChild("Equipment")){
                            ...
                            Toast.makeText(view_reference_records.this, "This Aircraft Record doesn't have Any Equipment Record~", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    }
